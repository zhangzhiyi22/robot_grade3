...
class FilterParams_Request(metaclass=Metaclass_FilterParams_Request):
    ...
    def x_filter_min(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'x_filter_min' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def x_filter_max(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'x_filter_max' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def y_filter_min(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'y_filter_min' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def y_filter_max(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'y_filter_max' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def z_filter_min(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'z_filter_min' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def z_filter_max(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'z_filter_max' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def voxel_leaf_size(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'voxel_leaf_size' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def plane_dist_thresh(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'plane_dist_thresh' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def ror_radius_search(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'ror_radius_search' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def cluster_tol(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'cluster_tol' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
