...
#include "interbotix_perception_msgs/srv/detail/cluster_info_array__type_support.h"
...
static const _ClusterInfoArray_Request_type_support_symbol_names_t _ClusterInfoArray_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interbotix_perception_msgs, srv, ClusterInfoArray_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interbotix_perception_msgs, srv, ClusterInfoArray_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, interbotix_perception_msgs, srv, ClusterInfoArray_Request)() {
  return &::interbotix_perception_msgs::srv::rosidl_typesupport_c::ClusterInfoArray_Request_message_type_support_handle;
}
...
static const _ClusterInfoArray_Response_type_support_symbol_names_t _ClusterInfoArray_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interbotix_perception_msgs, srv, ClusterInfoArray_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interbotix_perception_msgs, srv, ClusterInfoArray_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, interbotix_perception_msgs, srv, ClusterInfoArray_Response)() {
  return &::interbotix_perception_msgs::srv::rosidl_typesupport_c::ClusterInfoArray_Response_message_type_support_handle;
}
...
static const _ClusterInfoArray_type_support_symbol_names_t _ClusterInfoArray_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interbotix_perception_msgs, srv, ClusterInfoArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interbotix_perception_msgs, srv, ClusterInfoArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, interbotix_perception_msgs, srv, ClusterInfoArray)() {
  return &::interbotix_perception_msgs::srv::rosidl_typesupport_c::ClusterInfoArray_service_type_support_handle;
}
