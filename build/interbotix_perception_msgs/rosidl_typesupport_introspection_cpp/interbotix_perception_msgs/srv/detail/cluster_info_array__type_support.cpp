...
void fetch_function__ClusterInfoArray_Response__clusters(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const interbotix_perception_msgs::msg::ClusterInfo *>(
    get_const_function__ClusterInfoArray_Response__clusters(untyped_member, index));
  auto & value = *reinterpret_cast<interbotix_perception_msgs::msg::ClusterInfo *>(untyped_value);
  value = item;
}

void assign_function__ClusterInfoArray_Response__clusters(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<interbotix_perception_msgs::msg::ClusterInfo *>(
    get_function__ClusterInfoArray_Response__clusters(untyped_member, index));
  const auto & value = *reinterpret_cast<const interbotix_perception_msgs::msg::ClusterInfo *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ClusterInfoArray_Response_message_member_array[1] = {
  {
    ...
    fetch_function__ClusterInfoArray_Response__clusters,  // fetch(index, &value) function pointer
    assign_function__ClusterInfoArray_Response__clusters,  // assign(index, value) function pointer
