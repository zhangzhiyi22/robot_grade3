...
void interbotix_xs_msgs__msg__ArmJoy__rosidl_typesupport_introspection_c__ArmJoy_init_function(
...
void interbotix_xs_msgs__msg__ArmJoy__rosidl_typesupport_introspection_c__ArmJoy_fini_function(void * message_memory)
{
  interbotix_xs_msgs__msg__ArmJoy__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember interbotix_xs_msgs__msg__ArmJoy__rosidl_typesupport_introspection_c__ArmJoy_message_member_array[12] = {
  {
    "ee_x_cmd",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers interbotix_xs_msgs__msg__ArmJoy__rosidl_typesupport_introspection_c__ArmJoy_message_members = {
  "interbotix_xs_msgs__msg",  // message namespace
  "ArmJoy",  // message name
  12,  // number of fields
  sizeof(interbotix_xs_msgs__msg__ArmJoy),
  interbotix_xs_msgs__msg__ArmJoy__rosidl_typesupport_introspection_c__ArmJoy_message_member_array,  // message members
  interbotix_xs_msgs__msg__ArmJoy__rosidl_typesupport_introspection_c__ArmJoy_init_function,  // function to initialize message memory (memory has to be allocated)
  interbotix_xs_msgs__msg__ArmJoy__rosidl_typesupport_introspection_c__ArmJoy_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t interbotix_xs_msgs__msg__ArmJoy__rosidl_typesupport_introspection_c__ArmJoy_message_type_support_handle = {
  0,
  &interbotix_xs_msgs__msg__ArmJoy__rosidl_typesupport_introspection_c__ArmJoy_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interbotix_xs_msgs, msg, ArmJoy)() {
  if (!interbotix_xs_msgs__msg__ArmJoy__rosidl_typesupport_introspection_c__ArmJoy_message_type_support_handle.typesupport_identifier) {
    interbotix_xs_msgs__msg__ArmJoy__rosidl_typesupport_introspection_c__ArmJoy_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &interbotix_xs_msgs__msg__ArmJoy__rosidl_typesupport_introspection_c__ArmJoy_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
