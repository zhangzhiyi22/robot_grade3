...
interbotix_xs_msgs__msg__HexJoy__create()
{
  ...
  interbotix_xs_msgs__msg__HexJoy * msg = (interbotix_xs_msgs__msg__HexJoy *)allocator.allocate(sizeof(interbotix_xs_msgs__msg__HexJoy), allocator.state);
  if (!msg) {
    return NULL;
  }
...
interbotix_xs_msgs__msg__HexJoy__Sequence__init(interbotix_xs_msgs__msg__HexJoy__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (interbotix_xs_msgs__msg__HexJoy *)allocator.zero_allocate(size, sizeof(interbotix_xs_msgs__msg__HexJoy), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interbotix_xs_msgs__msg__HexJoy__Sequence * array = (interbotix_xs_msgs__msg__HexJoy__Sequence *)allocator.allocate(sizeof(interbotix_xs_msgs__msg__HexJoy__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  interbotix_xs_msgs__msg__HexJoy__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    interbotix_xs_msgs__msg__HexJoy * data =
      (interbotix_xs_msgs__msg__HexJoy *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interbotix_xs_msgs__msg__HexJoy__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          interbotix_xs_msgs__msg__HexJoy__fini(&output->data[i]);
        }
        return false;
      }
    }
