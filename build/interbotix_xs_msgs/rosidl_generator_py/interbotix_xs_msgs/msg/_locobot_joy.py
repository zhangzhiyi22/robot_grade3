...
class LocobotJoy(metaclass=Metaclass_LocobotJoy):
    ...
    def base_x_cmd(self, value):
        if __debug__:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'base_x_cmd' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
    ...
    def base_theta_cmd(self, value):
        if __debug__:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'base_theta_cmd' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
