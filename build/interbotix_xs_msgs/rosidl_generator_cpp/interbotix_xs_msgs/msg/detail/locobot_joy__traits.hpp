...
#ifndef INTERBOTIX_XS_MSGS__MSG__DETAIL__LOCOBOT_JOY__TRAITS_HPP_
#define INTERBOTIX_XS_MSGS__MSG__DETAIL__LOCOBOT_JOY__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  {
    out << "base_x_cmd: ";
    rosidl_generator_traits::value_to_yaml(msg.base_x_cmd, out);
    out << ", ";
  }
  ...
  {
    out << "base_theta_cmd: ";
    rosidl_generator_traits::value_to_yaml(msg.base_theta_cmd, out);
    out << ", ";
  }

  // member: base_reset_odom_cmd
  {
    out << "base_reset_odom_cmd: ";
    rosidl_generator_traits::value_to_yaml(msg.base_reset_odom_cmd, out);
    out << ", ";
  }
...
inline std::string to_yaml(const LocobotJoy & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const interbotix_xs_msgs::msg::LocobotJoy & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const interbotix_xs_msgs::msg::LocobotJoy & msg)
{
  return interbotix_xs_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<interbotix_xs_msgs::msg::LocobotJoy>()
{
  return "interbotix_xs_msgs::msg::LocobotJoy";
}

template<>
inline const char * name<interbotix_xs_msgs::msg::LocobotJoy>()
{
  return "interbotix_xs_msgs/msg/LocobotJoy";
}

template<>
struct has_fixed_size<interbotix_xs_msgs::msg::LocobotJoy>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<interbotix_xs_msgs::msg::LocobotJoy>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<interbotix_xs_msgs::msg::LocobotJoy>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // INTERBOTIX_XS_MSGS__MSG__DETAIL__LOCOBOT_JOY__TRAITS_HPP_
