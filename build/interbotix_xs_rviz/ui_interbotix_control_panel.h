...
public:
    ...
    QLabel *label_homesleep_;
    QComboBox *combobox_homesleep_name_;
    ...
    void setupUi(QWidget *InterbotixControlPanelUI)
    {
        ...
        InterbotixControlPanelUI->resize(401, 290);
        ...
        InterbotixControlPanelUI->setMinimumSize(QSize(0, 0));
        InterbotixControlPanelUI->setMaximumSize(QSize(401, 315));
        ...
        label_homesleep_ = new QLabel(tab_home_sleep_);
        label_homesleep_->setObjectName(QString::fromUtf8("label_homesleep_"));
        QSizePolicy sizePolicy3(QSizePolicy::Preferred, QSizePolicy::Maximum);
        sizePolicy3.setHorizontalStretch(0);
        sizePolicy3.setVerticalStretch(0);
        sizePolicy3.setHeightForWidth(label_homesleep_->sizePolicy().hasHeightForWidth());
        label_homesleep_->setSizePolicy(sizePolicy3);

        horizontalLayout_4->addWidget(label_homesleep_);

        combobox_homesleep_name_ = new QComboBox(tab_home_sleep_);
        combobox_homesleep_name_->addItem(QString());
        combobox_homesleep_name_->setObjectName(QString::fromUtf8("combobox_homesleep_name_"));
        combobox_homesleep_name_->setEnabled(false);
        QSizePolicy sizePolicy4(QSizePolicy::Expanding, QSizePolicy::Fixed);
        sizePolicy4.setHorizontalStretch(0);
        sizePolicy4.setVerticalStretch(0);
        sizePolicy4.setHeightForWidth(combobox_homesleep_name_->sizePolicy().hasHeightForWidth());
        combobox_homesleep_name_->setSizePolicy(sizePolicy4);

        horizontalLayout_4->addWidget(combobox_homesleep_name_);
        ...
        sizePolicy5.setHeightForWidth(button_gotohome_->sizePolicy().hasHeightForWidth());
        button_gotohome_->setSizePolicy(sizePolicy5);
        button_gotohome_->setMinimumSize(QSize(0, 80));
        ...
        sizePolicy6.setHeightForWidth(button_gotosleep_->sizePolicy().hasHeightForWidth());
        button_gotosleep_->setSizePolicy(sizePolicy6);
        button_gotosleep_->setMinimumSize(QSize(0, 80));
        ...
        sizePolicy7.setHeightForWidth(radiobutton_torque_group_->sizePolicy().hasHeightForWidth());
        radiobutton_torque_group_->setSizePolicy(sizePolicy7);
        ...
        sizePolicy7.setHeightForWidth(radiobutton_torque_single_->sizePolicy().hasHeightForWidth());
        radiobutton_torque_single_->setSizePolicy(sizePolicy7);
        ...
        sizePolicy8.setHeightForWidth(label_torque_warning_->sizePolicy().hasHeightForWidth());
        label_torque_warning_->setSizePolicy(sizePolicy8);
        QFont font;
        ...
        sizePolicy7.setHeightForWidth(radiobutton_opmodes_group_->sizePolicy().hasHeightForWidth());
        radiobutton_opmodes_group_->setSizePolicy(sizePolicy7);
        ...
        sizePolicy7.setHeightForWidth(radiobutton_opmodes_single_->sizePolicy().hasHeightForWidth());
        radiobutton_opmodes_single_->setSizePolicy(sizePolicy7);
        ...
        sizePolicy8.setHeightForWidth(label_opmodes_profile_type_->sizePolicy().hasHeightForWidth());
        label_opmodes_profile_type_->setSizePolicy(sizePolicy8);
        ...
        sizePolicy8.setHeightForWidth(label_opmodes_profile_vel_->sizePolicy().hasHeightForWidth());
        label_opmodes_profile_vel_->setSizePolicy(sizePolicy8);
        ...
        sizePolicy9.setHeightForWidth(label_opmodes_mode_->sizePolicy().hasHeightForWidth());
        label_opmodes_mode_->setSizePolicy(sizePolicy9);
        ...
        sizePolicy8.setHeightForWidth(label_opmodes_profile_acc_->sizePolicy().hasHeightForWidth());
        label_opmodes_profile_acc_->setSizePolicy(sizePolicy8);
        ...
        sizePolicy10.setHeightForWidth(label_getregval_desc_->sizePolicy().hasHeightForWidth());
        label_getregval_desc_->setSizePolicy(sizePolicy10);
        ...
        sizePolicy11.setHeightForWidth(button_estop_->sizePolicy().hasHeightForWidth());
        button_estop_->setSizePolicy(sizePolicy11);
...
""));
    ...
    {
        InterbotixControlPanelUI->setWindowTitle(QCoreApplication::translate("InterbotixControlPanelUI", "Form", nullptr));
        label_robot_namespace_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Robot Namespace:", nullptr));
        pushbutton_robot_namespace_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Update", nullptr));
#if QT_CONFIG(tooltip)
        tab_home_sleep_->setToolTip(QString());
#endif // QT_CONFIG(tooltip)
        label_homesleep_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Group Name:", nullptr));
        combobox_homesleep_name_->setItemText(0, QCoreApplication::translate("InterbotixControlPanelUI", "Select:", nullptr));

        button_gotohome_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Go to Home Pose", nullptr));
        button_gotosleep_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Go to Sleep Pose", nullptr));
        tabs_->setTabText(tabs_->indexOf(tab_home_sleep_), QCoreApplication::translate("InterbotixControlPanelUI", "Home/Sleep", nullptr));
#if QT_CONFIG(tooltip)
        tab_torque_enable_->setToolTip(QString());
#endif // QT_CONFIG(tooltip)
        label_torque_name_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Name:", nullptr));
        combobox_torque_name_->setItemText(0, QCoreApplication::translate("InterbotixControlPanelUI", "Select:", nullptr));

        radiobutton_torque_group_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Group", nullptr));
        radiobutton_torque_single_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Single", nullptr));
        label_torque_warning_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "<strong>WARNING:</strong> Disabling torque will cause the robot to collapse! Hold on to it or command it to its sleep configuration before disabling!", nullptr));
        label_torque_state_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Torque State:", nullptr));
        button_torque_enable_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Enable", nullptr));
        button_torque_disable_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Disable", nullptr));
        tabs_->setTabText(tabs_->indexOf(tab_torque_enable_), QCoreApplication::translate("InterbotixControlPanelUI", "Torque", nullptr));
#if QT_CONFIG(tooltip)
        tabs_->setTabToolTip(tabs_->indexOf(tab_torque_enable_), QCoreApplication::translate("InterbotixControlPanelUI", "Enable and disable the torque of a given robot", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        tab_operating_modes_->setToolTip(QString());
#endif // QT_CONFIG(tooltip)
        label_opmodes_name_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Name:", nullptr));
        combobox_opmodes_name_->setItemText(0, QCoreApplication::translate("InterbotixControlPanelUI", "Select:", nullptr));

        radiobutton_opmodes_group_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Group", nullptr));
        radiobutton_opmodes_single_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Single", nullptr));
        label_opmodes_profile_type_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Type:", nullptr));
        combobox_opmodes_profile_type_->setItemText(0, QCoreApplication::translate("InterbotixControlPanelUI", "time", nullptr));
        combobox_opmodes_profile_type_->setItemText(1, QCoreApplication::translate("InterbotixControlPanelUI", "velocity", nullptr));

        label_opmodes_profile_vel_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Profile Velocity: ", nullptr));
        label_opmodes_mode_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Mode:", nullptr));
        combobox_opmodes_mode_->setItemText(0, QCoreApplication::translate("InterbotixControlPanelUI", "position", nullptr));
        combobox_opmodes_mode_->setItemText(1, QCoreApplication::translate("InterbotixControlPanelUI", "ext_position", nullptr));
        combobox_opmodes_mode_->setItemText(2, QCoreApplication::translate("InterbotixControlPanelUI", "velocity", nullptr));
        combobox_opmodes_mode_->setItemText(3, QCoreApplication::translate("InterbotixControlPanelUI", "current", nullptr));
        combobox_opmodes_mode_->setItemText(4, QCoreApplication::translate("InterbotixControlPanelUI", "current_based_position", nullptr));
        combobox_opmodes_mode_->setItemText(5, QCoreApplication::translate("InterbotixControlPanelUI", "pwm", nullptr));

        label_opmodes_profile_acc_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Profile Acceleration:", nullptr));
        lineedit_opmodes_profile_acc_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "300", nullptr));
        lineedit_opmodes_profile_vel_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "2000", nullptr));
        button_opmodes_set_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Set Operating Modes", nullptr));
        tabs_->setTabText(tabs_->indexOf(tab_operating_modes_), QCoreApplication::translate("InterbotixControlPanelUI", "Operating Modes", nullptr));
#if QT_CONFIG(tooltip)
        tab_reboot_->setToolTip(QString());
#endif // QT_CONFIG(tooltip)
        label_reboot_name_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Name:", nullptr));
        combobox_reboot_name_->setItemText(0, QCoreApplication::translate("InterbotixControlPanelUI", "Select:", nullptr));

        radiobutton_reboot_group_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Group", nullptr));
        radiobutton_reboot_single_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Single", nullptr));
        checkbox_smart_reboot_->setText(QString());
        label_2->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Only reboot motors in group that are in an error state", nullptr));
        checkbox_reboot_enable_->setText(QString());
        label->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Enable torque on selected servos after reboot", nullptr));
        button_reboot_reboot_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Reboot", nullptr));
        tabs_->setTabText(tabs_->indexOf(tab_reboot_), QCoreApplication::translate("InterbotixControlPanelUI", "Reboot", nullptr));
#if QT_CONFIG(tooltip)
        tab_getregval_->setToolTip(QString());
#endif // QT_CONFIG(tooltip)
        label_getregval_name_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Name:", nullptr));
        combobox_getregval_name_->setItemText(0, QCoreApplication::translate("InterbotixControlPanelUI", "Select:", nullptr));

        radiobutton_getregval_group_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Group", nullptr));
        radiobutton_getregval_single_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Single", nullptr));
        label_getregval_reg_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Register:", nullptr));
        combobox_getregval_reg_->setItemText(0, QCoreApplication::translate("InterbotixControlPanelUI", "Goal_Position", nullptr));
        combobox_getregval_reg_->setItemText(1, QCoreApplication::translate("InterbotixControlPanelUI", "Goal_Velocity", nullptr));
        combobox_getregval_reg_->setItemText(2, QCoreApplication::translate("InterbotixControlPanelUI", "Goal_Current", nullptr));
        combobox_getregval_reg_->setItemText(3, QCoreApplication::translate("InterbotixControlPanelUI", "Goal_PWM", nullptr));
        combobox_getregval_reg_->setItemText(4, QCoreApplication::translate("InterbotixControlPanelUI", "Present_Position", nullptr));
        combobox_getregval_reg_->setItemText(5, QCoreApplication::translate("InterbotixControlPanelUI", "Present_Velocity", nullptr));
        combobox_getregval_reg_->setItemText(6, QCoreApplication::translate("InterbotixControlPanelUI", "Present_Current", nullptr));
        combobox_getregval_reg_->setItemText(7, QCoreApplication::translate("InterbotixControlPanelUI", "Present_Temperature", nullptr));

        button_getregval_val_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "Get", nullptr));
        label_getregval_desc_->setText(QString());
        tabs_->setTabText(tabs_->indexOf(tab_getregval_), QCoreApplication::translate("InterbotixControlPanelUI", "Get Register Values", nullptr));
#if QT_CONFIG(tooltip)
        tab_estop_->setToolTip(QString());
#endif // QT_CONFIG(tooltip)
        label_estop_warning_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "<strong>WARNING:</strong> This action will kill the xs_sdk node, causing the robot to cease all movement and collapse. This may damage the robot.", nullptr));
        button_estop_->setText(QCoreApplication::translate("InterbotixControlPanelUI", "E-STOP", nullptr));
        tabs_->setTabText(tabs_->indexOf(tab_estop_), QCoreApplication::translate("InterbotixControlPanelUI", "E-Stop", nullptr));
#if QT_CONFIG(tooltip)
        tabs_->setTabToolTip(tabs_->indexOf(tab_estop_), QCoreApplication::translate("InterbotixControlPanelUI", "Kill the control node of a given robot in an emergency", nullptr));
#endif // QT_CONFIG(tooltip)
    } // retranslateUi
