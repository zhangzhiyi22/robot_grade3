...
bool pan_tilt_msgs__msg__pan_tilt_cmd_deg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pan_tilt_msgs.msg._pan_tilt_cmd_deg.PanTiltCmdDeg", full_classname_dest, 49) == 0);
  }
  pan_tilt_msgs__msg__PanTiltCmdDeg * ros_message = _ros_message;
  {  // yaw
...
{
  /* NOTE(esteve): Call constructor of PanTiltCmdDeg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("pan_tilt_msgs.msg._pan_tilt_cmd_deg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PanTiltCmdDeg");
