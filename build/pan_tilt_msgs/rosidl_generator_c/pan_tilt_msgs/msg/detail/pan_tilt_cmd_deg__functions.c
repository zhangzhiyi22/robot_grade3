...
pan_tilt_msgs__msg__PanTiltCmdDeg__create()
{
  ...
  pan_tilt_msgs__msg__PanTiltCmdDeg * msg = (pan_tilt_msgs__msg__PanTiltCmdDeg *)allocator.allocate(sizeof(pan_tilt_msgs__msg__PanTiltCmdDeg), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(pan_tilt_msgs__msg__PanTiltCmdDeg));
  bool success = pan_tilt_msgs__msg__PanTiltCmdDeg__init(msg);
  if (!success) {
...
pan_tilt_msgs__msg__PanTiltCmdDeg__destroy(pan_tilt_msgs__msg__PanTiltCmdDeg * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    pan_tilt_msgs__msg__PanTiltCmdDeg__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
pan_tilt_msgs__msg__PanTiltCmdDeg__Sequence__init(pan_tilt_msgs__msg__PanTiltCmdDeg__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pan_tilt_msgs__msg__PanTiltCmdDeg * data = NULL;

  if (size) {
    data = (pan_tilt_msgs__msg__PanTiltCmdDeg *)allocator.zero_allocate(size, sizeof(pan_tilt_msgs__msg__PanTiltCmdDeg), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = pan_tilt_msgs__msg__PanTiltCmdDeg__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        pan_tilt_msgs__msg__PanTiltCmdDeg__fini(&data[i - 1]);
      }
...
pan_tilt_msgs__msg__PanTiltCmdDeg__Sequence__fini(pan_tilt_msgs__msg__PanTiltCmdDeg__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      pan_tilt_msgs__msg__PanTiltCmdDeg__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pan_tilt_msgs__msg__PanTiltCmdDeg__Sequence * array = (pan_tilt_msgs__msg__PanTiltCmdDeg__Sequence *)allocator.allocate(sizeof(pan_tilt_msgs__msg__PanTiltCmdDeg__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = pan_tilt_msgs__msg__PanTiltCmdDeg__Sequence__init(array, size);
  if (!success) {
...
pan_tilt_msgs__msg__PanTiltCmdDeg__Sequence__destroy(pan_tilt_msgs__msg__PanTiltCmdDeg__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    pan_tilt_msgs__msg__PanTiltCmdDeg__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
pan_tilt_msgs__msg__PanTiltCmdDeg__Sequence__are_equal(const pan_tilt_msgs__msg__PanTiltCmdDeg__Sequence * lhs, const pan_tilt_msgs__msg__PanTiltCmdDeg__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!pan_tilt_msgs__msg__PanTiltCmdDeg__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  pan_tilt_msgs__msg__PanTiltCmdDeg__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(pan_tilt_msgs__msg__PanTiltCmdDeg);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    pan_tilt_msgs__msg__PanTiltCmdDeg * data =
      (pan_tilt_msgs__msg__PanTiltCmdDeg *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!pan_tilt_msgs__msg__PanTiltCmdDeg__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          pan_tilt_msgs__msg__PanTiltCmdDeg__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!pan_tilt_msgs__msg__PanTiltCmdDeg__copy(
