...
static const _PanJointState_type_support_symbol_names_t _PanJointState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pan_tilt_msgs, msg, PanJointState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pan_tilt_msgs, msg, PanJointState)),
  }
};
...
{
  return &::pan_tilt_msgs::msg::rosidl_typesupport_cpp::PanJointState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pan_tilt_msgs, msg, PanJointState)() {
  return get_message_type_support_handle<pan_tilt_msgs::msg::PanJointState>();
}
